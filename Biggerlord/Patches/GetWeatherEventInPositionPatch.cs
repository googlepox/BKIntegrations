...
{
    internal class GetWeatherEventInPositionPatch
    {
        //[HarmonyPatch(typeof(DefaultMapWeatherModel), "GetWeatherEventInPosition")]
        public static bool GetWeatherEventInPositionPrefix(DefaultMapWeatherModel __instance, MapWeatherModel.WeatherEvent[] ____weatherDataCache, ref MapWeatherModel.WeatherEvent __result, Vec2 pos)
        {
