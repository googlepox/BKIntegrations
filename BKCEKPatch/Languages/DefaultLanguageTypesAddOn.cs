...
{
    internal class DefaultLanguageTypesAddOn : DefaultTypeInitializer<DefaultLanguageTypesAddOn, Language>
    {
        ...
        public override void Initialize()
        {
            ...
            this.Vagiric.Initialize(new TextObject("Vagiric"), new TextObject("Vagiric is a relatively new language in Calradia, a rich and diverse mixture of Sturgian syntax and Battanian vocabulary. The ancient Sturgian language remains relatively strong in the form of Vagiric, although outside influences can clearly be seen in Battanian, Calradic, and Palaic influences."), objectTypeList.First<CultureObject>((Func<CultureObject, bool>)(x => x.StringId == "vagir")), this.GetIntelligibles(this.Vagiric));
            this.Lyrion.Initialize(new TextObject("Lyrion"), new TextObject("Although few Calradians speak Lyrion and even fewer still have been to Lyria, the recent influx of Lyrion soldiers and outposts have led to a rise in linguistic trade and many merchants to southern lands now need to speak it. It is described as \'totally foreign\', and bears little to no similarities with Aseran. "), objectTypeList.First<CultureObject>((Func<CultureObject, bool>)(x => x.StringId == "lyrion")), this.GetIntelligibles(this.Lyrion));
            this.Nordic.Initialize(new TextObject("Nordic"), new TextObject("Hailing from the lands of Jumne to the far north, the Nords carried their ancient language with them to the south. The Nordic language has seen derivatives in the form of Sturgian and even further Vagiric, and some scholars have been puzzled by ancient Palaic words bearing Nordic origins, suggesting the Nords had frequent contact with Calradia for longer than initially thought."), objectTypeList.First<CultureObject>((Func<CultureObject, bool>)(x => x.StringId == "nordling")), this.GetIntelligibles(this.Nordic));
            this.Apolssalian.Initialize(new TextObject("Apolssalian"), new TextObject("Apolssaly is said to be a beautiful trading kingdom situated along an inland bay to the southeast of Calradia, and its language is equally rich and beautiful. Apolssalian bears influences from countless other languages, including Asera, Calradic, and even hints of the Balic language far to the west."), objectTypeList.First<CultureObject>((Func<CultureObject, bool>)(x => x.StringId == "apolssalian")), this.GetIntelligibles(this.Apolssalian));
            this.Palaic.Initialize(new TextObject("Palaic"), new TextObject("Though thought to be nearly extinct due to centuries of Imperial Oppression, the recent uprising by the Palaic people has seen a renaissance of the indigenous language. Although there once were countless dialects of Palaic due to the tribal nature of Palaic society, there now remains only one; a bastardized version of the ancient language intermingled with Calradic syntax and vocubulary. This only gives the Palaic people more reason to fight the Empire, and they hope to one day be free to speak their natural language once more."), objectTypeList.First<CultureObject>((Func<CultureObject, bool>)(x => x.StringId == "paleician")), this.GetIntelligibles(this.Palaic));
