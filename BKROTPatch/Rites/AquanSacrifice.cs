...
{
    internal class LionOfNightSacrifice : Sacrifice
    {
        public override TextObject GetDescription()
        {
            return new TextObject("A life is given, a debt paid. The Lion’s roar echoes in the night — and none may escape his sight.", null);
        }

        public override TextObject GetName()
        {
            return new TextObject("Blood for Vengeance", null);
        }
