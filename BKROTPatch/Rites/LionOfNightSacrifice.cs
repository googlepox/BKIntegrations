...
{
    internal class AquanSacrifice : Sacrifice
    {
        public override TextObject GetDescription()
        {
            return new TextObject("Flames lick offerings as life is pledged. Aquan roars, igniting passion and resilience in his followers.", null);
        }

        public override TextObject GetName()
        {
            return new TextObject("Flesh and Fire", null);
        }
