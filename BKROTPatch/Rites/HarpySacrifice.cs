...
{
    internal class HarpySacrifice : Sacrifice
    {
        public override TextObject GetDescription()
        {
            return new TextObject("Your offering of blood lies before her. The Harpy ensures the endurance of houses, families, and traditions.", null);
        }

        public override TextObject GetName()
        {
            return new TextObject("The Octarch's Tribute", null);
        }
