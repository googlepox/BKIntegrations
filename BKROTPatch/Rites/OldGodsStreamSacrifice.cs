...
{
    internal class OldGodsStreamSacrifice : Sacrifice
    {
        public override TextObject GetDescription()
        {
            return new TextObject("The crimson flows into the current, vanishing without a ripple. The Stream remembers, carrying your vow to the heart of the forest.", null);
        }

        public override TextObject GetName()
        {
            return new TextObject("Blood to the Waters", null);
        }
